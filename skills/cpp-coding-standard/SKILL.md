...
description: 面向 C++ 项目的专项工程规范，覆盖语言与风格、构建、头文件、资源所有权、生命周期、类型与接口、错误、并发、API/ABI、测试、工具链、可移植性和性能；通用日志、安全、提交与审查规则遵循 common-coding-standards。
---
...
1. 识别语言标准、编译器/标准库、目标平台/架构、构建系统、异常/RTTI 策略和公开边界。
