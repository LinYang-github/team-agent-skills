...
[plugin-packager](../skills/plugin-packager/SKILL.md) 将产品项目已有的 Skill、MCP、MCP Apps 和可选 Agent 整理为 HuiMate 可导入的插件目录与 ZIP。使用 Python 3.10+，脚本仅依赖标准库，不启动产品服务、不联网、不发布制品。
