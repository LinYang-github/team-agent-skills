#!/usr/bin/env bash
# 用途：批量安装团队 Skill 到 Claude；当前脚本只处理 Claude。
# 普通安装：./scripts/install-claude-macos.sh
# 强制安装：./scripts/install-claude-macos.sh --force
set -euo pipefail
...
echo
echo "Claude Skill installation complete."
